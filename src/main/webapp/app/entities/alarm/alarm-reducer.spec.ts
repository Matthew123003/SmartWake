...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './alarm.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ALARM_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ALARM actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ALARM actions', async () => {
      const arg = { id: 'CBA' };
    ...
    it('dispatches UPDATE_ALARM actions', async () => {
      const arg = { id: 'CBA' };
    ...
    it('dispatches PARTIAL_UPDATE_ALARM actions', async () => {
      const arg = { id: 'ABC' };
    ...
    it('dispatches DELETE_ALARM actions', async () => {
      const arg = 42666;
