...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_USERLOGIN_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_USERLOGIN actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_USERLOGIN actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_USERLOGIN actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_USERLOGIN actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_USERLOGIN actions', async () => {
      const arg = 42666;
